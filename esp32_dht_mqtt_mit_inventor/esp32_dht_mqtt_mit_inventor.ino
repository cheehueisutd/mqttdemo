...
//defining Pins
// DHT22 Sensor
#define DHTPIN 14  //using GPIO14 (D5) to read data from DHT22
// #define DHTPIN 5
#define LED 2
...
//MQTT Credentials
const char* ssid = "xxx";//setting your ap ssid
const char* password = "xxx";//setting your ap psk
const char* mqttServer = "broker.emqx.io"; //MQTT URL
const char* mqttUserName = "emqx";  // MQTT username
const char* mqttPwd = "public";  // MQTT password
